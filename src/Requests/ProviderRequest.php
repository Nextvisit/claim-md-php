...
class ProviderRequest
{
     ...
     */
    private const string ENROLLMENT_ENDPOINT = '/services/enroll/';
     ...
     *                                                        If an array is provided, it should contain the necessary
     *                                                        enrollment data. If a ProviderEnrollmentDTO is provided,
